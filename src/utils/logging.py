...
def create_one_logger(name: str, log_file: str, level=logging.INFO):
...
class LogMessage:
    ...
    @staticmethod
    def receive_command(command_list, log_name="command"):
        log = logging.getLogger(log_name)
        command_str = " ".join(command_list)
        log.info("command received from ADMIN " + command_str)

    @staticmethod
    def send_command(command, log_name="command"):
        log = logging.getLogger(log_name)
